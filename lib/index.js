    ...
    handler: async (req, res) => {
      ...
      if (tail === "/state" || tail === "") {
        ...
        sendJson(res, 200, {
          ...
          budget: { ...budget },
          history: rangeDays,
          byModel: Object.fromEntries([...[...range.byProviderModel.entries()].reduce((acc, [key, counts]) => {
          ...
          byProvider: Object.fromEntries([...range.byProvider.entries()].map(([provider, counts]) => [provider, {
            ...counts,
            derived: !configuredProviders.has(provider) && !(provider in CODING_PLAN_PRICING)
          }]).sort((a, b) => b[1].cost - a[1].cost)),
          configuredProviders: [...configuredProviders],
          byProviderModel: Object.fromEntries([...range.byProviderModel.entries()]
            .map(([key, counts]) => {
              const sep = key.indexOf("\x00");
