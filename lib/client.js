	...
	factory: (require) => {
							...
							react_jsx_runtime.jsxs("div", {
								...
								children: [
									...
									react_jsx_runtime.jsx("span", {
										...
										style: isSaveOnly ? { color: SAVED_COLOR } : void 0,
										children: value
									})
								]
							}),
		...
		*/
		function SettingsBillingSection({ useBilling, useLocale, t }) {
			...
			return react_jsx_runtime.jsxs("div", {
				...
				children: [
					...
					react_jsx_runtime.jsx("div", { className: css_default.sep }),
					// ── 按来源分组 ──
					react_jsx_runtime.jsx("p", { className: css_default.sectionTitle, children: t("bySource") }),
					SOURCE_META.map((meta) => {
						...
						const rows = bucket.entries.slice(0, 10).map((entry) => {
							...
							return react_jsx_runtime.jsxs("div", {
								style: { display: "flex", justifyContent: "space-between", gap: 10, minWidth: 0, fontSize: 12, lineHeight: 18, padding: "2px 0" },
								children: [
									react_jsx_runtime.jsx("span", {
										style: { minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", color: "var(--dsw-alias-label-secondary)" },
										children: `${entry.provider} · ${entry.model}`
									}),
									react_jsx_runtime.jsx("span", {
										style: { flex: "none", color: eSaveOnly ? meta.color : "var(--dsw-alias-label-primary)", fontVariantNumeric: "tabular-nums" },
						...
						return react_jsx_runtime.jsxs("div", {
							style: { border: "1px solid var(--dsw-alias-border-l1)", borderRadius: 12, padding: "10px 12px", marginBottom: 8, borderLeft: `3px solid ${meta.color}` },
							children: [
								react_jsx_runtime.jsxs("div", {
									style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 10, minWidth: 0 },
									children: [
										react_jsx_runtime.jsx("span", {
											style: { fontSize: 13, fontWeight: 600, color: meta.color, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" },
											children: headline
										}),
										react_jsx_runtime.jsx("span", {
											style: { flex: "none", fontSize: 11, color: "var(--dsw-alias-label-tertiary)" },
											children: `${t("calls")} ${formatNumber(bucket.calls)}`
										})
									]
								}),
								meta.key === "subscription" && bucket.monthly > 0 && react_jsx_runtime.jsx("div", {
									style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary)", marginTop: 2 },
									children: `${t("source.monthly")} ${formatCost(symbol, currency === "USD" ? bucket.monthly / 7.2 : bucket.monthly)}`
								}),
								rows
							]
						}, meta.key);
					...
					// ── Provider 收费形式编辑 ──
					react_jsx_runtime.jsx("p", { className: css_default.sectionTitle, children: t("metering.title") }),
					react_jsx_runtime.jsx("div", {
						...
						children: [
							Object.keys(byProvider).map((provider) => {
								...
								return react_jsx_runtime.jsxs("div", {
									style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", fontSize: 12, lineHeight: 18 },
									children: [
										react_jsx_runtime.jsx("span", { style: { minWidth: 130, color: "var(--dsw-alias-label-secondary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: provider }),
										react_jsx_runtime.jsx("select", {
											style: { font: "inherit", fontSize: 12, padding: "2px 6px", borderRadius: 6, border: "1px solid var(--dsw-alias-border-l1)", background: "var(--dsw-alias-bg-base)", color: "var(--dsw-alias-label-primary)" },
											value: rule.mode,
											onChange: (event) => {
										...
										rule.mode === "subscription" && react_jsx_runtime.jsxs(react_jsx_runtime.Fragment, {
											children: [
												react_jsx_runtime.jsx("input", {
													type: "number",
													min: 0,
													style: { font: "inherit", fontSize: 12, width: 70, padding: "2px 6px", borderRadius: 6, border: "1px solid var(--dsw-alias-border-l1)", background: "var(--dsw-alias-bg-base)", color: "var(--dsw-alias-label-primary)" },
												...
												react_jsx_runtime.jsx("span", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 11 }, children: symbol + "/" + t("monthShort") })
											]
										})
									]
								}, provider);
							...
							react_jsx_runtime.jsxs("div", {
								...
								children: [
									react_jsx_runtime.jsx("button", {
										type: "button",
										className: css_default.button,
										onClick: async () => {
											const payload = meteringDraft === null ? metering : meteringDraft;
											try {
												const response = await fetch("/billing/metering", {
													method: "POST",
									...
									meteringSaved && react_jsx_runtime.jsx("span", { style: { color: "#16a34a", fontSize: 12 }, children: t("metering.saved") })
								]
							})
						]
					}),
		...
		const en = {
			...
			"source.subscription": "Subscription offset",
			"source.free": "Free",
			"source.coding": "Coding plan",
