window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const opaquePanelCss = ".b8l_panel{background:var(--dsw-static-neutral-bluish-00,#fff)}body[data-ds-dark-theme] .b8l_panel{background:var(--dsw-static-neutral-bluish-950,#151517)}";
