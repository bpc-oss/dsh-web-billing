		...
		*/
		function SessionCostBadge({ sessionId, useBilling, useLocale, refreshSession, t }) {
			...
			for (const message of messages) {
				...
				if (bucket === void 0) {
					bucket = { cost: 0, costUsd: 0, savings: 0, savingsUsd: 0, costNominal: 0, costNominalUsd: 0, calls: 0 };
						...
						open && react_jsx_runtime.jsxs("div", {
							...
							children: [
								...
								react_jsx_runtime.jsx("div", {
									...
									children: react_jsx_runtime.jsx("span", { children: `${t("calls")} ${formatNumber(session.calls)}` })
								}),
