		...
		function SessionCostBadge({ sessionId, useBilling, useLocale, refreshSession, t }) {
			...
			const modelRows = byModel === void 0 ? [] : Object.entries(byModel)
				...
				.map(([model, counts]) => {
					...
					return [model, value, isLocalModel ? `${t("nominal")} ${formatCost(symbol, currency === "USD" ? counts.costNominalUsd : counts.costNominal)}` : void 0];
				});
						...
						children: react_jsx_runtime.jsxs(react_jsx_runtime.Fragment, {
							children: [
								...
								open && react_jsx_runtime.jsxs("div", {
									...
									children: [
										react_jsx_runtime.jsx("div", {
											className: css_default.rowTriple,
											children: [
												react_jsx_runtime.jsx("span", {
													className: css_default.cell,
													children: [
														isSavingsBadge ? t("sessionSaved") : t("sessionCost"),
														react_jsx_runtime.jsx("b", { children: badgeValue })
													]
												}),
												balanceRow !== null && react_jsx_runtime.jsx("span", {
													...
													children: [
														t("balance"),
														react_jsx_runtime.jsx("b", { children: balanceRow[1] })
													]
												})
											]
										}),
										hasSavings && react_jsx_runtime.jsx("div", {
											className: css_default.rowTriple,
											...
											children: [
												react_jsx_runtime.jsx("span", {
													...
													children: [
														t("saved"),
														react_jsx_runtime.jsx("b", { children: formatCost(symbol, sessionSavings) })
													]
												}),
												react_jsx_runtime.jsx("span", {
													className: css_default.cell,
													children: [
														t("savedToday"),
														react_jsx_runtime.jsx("b", { children: formatCost(symbol, todaySavings) })
													]
												}),
												react_jsx_runtime.jsx("span", {
													className: css_default.cell,
													children: [
														t("savedMonth"),
														react_jsx_runtime.jsx("b", { children: formatCost(symbol, monthSavings) })
													]
												})
											]
										}),
										react_jsx_runtime.jsx("div", {
											...
											children: [
												react_jsx_runtime.jsx("span", {
													...
													children: [
														t("today"),
														react_jsx_runtime.jsx("b", { children: today === void 0 ? formatCost(symbol, 0) : formatCost(symbol, amountOf(today)) })
													]
												}),
												react_jsx_runtime.jsx("span", {
													className: css_default.cell,
													children: [
														t("month"),
														react_jsx_runtime.jsx("b", { children: month === void 0 ? formatCost(symbol, 0) : formatCost(symbol, amountOf(month)) })
													]
												}),
												react_jsx_runtime.jsx("span", {
													className: css_default.cell,
													children: [
														t("total"),
														react_jsx_runtime.jsx("b", { children: totals === void 0 ? formatCost(symbol, 0) : formatCost(symbol, amountOf(totals)) })
													]
												})
											]
										}),
										...
										modelRows.map(([model, value, detail]) => react_jsx_runtime.jsxs("div", {
